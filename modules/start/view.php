      ...
      <div class="col-lg-12 col-xs-12">
        <div class="alert alert-info alert-dismissable">
          ...
          <p style="font-size:15px">
            <i class="icon fa fa-user"></i> Bienvenido <strong><?php echo $_SESSION['name_user']; ?></strong> al Sistema SGI.
          </p>        
        </div>
      </div>  
    </div>
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div style="background-color:#00c0ef;color:#fff" class="small-box">
          <div class="inner">
            ...
            $query = mysqli_query($mysqli, "SELECT COUNT(iddeudores) as numero FROM deudores")
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div style="background-color:#00a65a;color:#fff" class="small-box">
          <div class="inner">
            ...
            $query = mysqli_query($mysqli, "SELECT COUNT(idgestionextrajudicial) as numero FROM gestionextrajudicial")
                                            or die('Error '.mysqli_error($mysqli));
            ...
            ?>
            <h3><?php echo $data['numero']; ?></h3>
            <p>Datos de Gestiones Extrajudicial</p>
          </div>
          <div class="icon">
