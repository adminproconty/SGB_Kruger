...
if ($_GET['form']=='add') { ?> 
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-cloud-upload icon-title"></i> Cargar Archivo
    </h1>
    <ol class="breadcrumb">
      <li><a href="?module=start"><i class="fa fa-home"></i> Inicio </a></li>
      <li><a href="?module=cargadata"> Carga de Archivos </a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
		<form action="modules/cargadata/proses.php?act=insert" method='post' enctype="multipart/form-data" class="form-horizontal">
			<div class="box-body">
			<?php  
          
              $query_id = mysqli_query($mysqli, "SELECT RIGHT(codigo,6) as codigo FROM cargas
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Código Carga</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="codigo" value="<?php echo $codigo; ?>" readonly required>
                </div>
              </div>
				<div class="form-group">
					<label class="col-sm-2 control-label">Tipo de Archivo</label>
					<div class="col-sm-5">
					  <select class="chosen-select" name="tipo_archivos" data-placeholder="-- Seleccionar --" autocomplete="off" required=''>
						<option value=""></option>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						   ...
						   <!-- <input name="guardar" type="submit" value="Importar" />  -->
				...
				<div class="box-footer">
				  <div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
					  <input type="submit" class="btn btn-primary btn-submit" name="Guardar" value="Cargar">
					  <a href="?module=cargadata" class="btn btn-default btn-reset">Cancelar</a>
					</div>
				  </div>
				</div><!-- /.box footer -->
			</div>	
...
elseif ($_GET['form']=='edit') { 
  if (isset($_GET['id'])) {
      ...
      $query = mysqli_query($mysqli, "SELECT codigo,tipo_archivos,(select name_user from usuarios where id_user = '$_GET[id]') as  usuario,fecha FROM cargas WHERE codigo='$_GET[id]'") 
                                      or die('error: '.mysqli_error($mysqli));
