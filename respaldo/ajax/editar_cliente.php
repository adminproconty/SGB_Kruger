<?php
	...
	if (empty($_POST['mod_id'])) {
		...
		$sql="UPDATE clientes SET nombre_cliente='".$nombre."', documento_cliente='".$documento."', telefono_cliente='".$telefono."', email_cliente='".$email."', direccion_cliente='".$direccion."', status_cliente='".$estado."' , saldo_cliente='".$saldo."' WHERE id_cliente='".$id_cliente."'";
