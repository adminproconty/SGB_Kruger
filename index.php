...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Login | Sistema de Gestión Integral</title>
  ...
  <body class="login-page bg-login">
    <div class="login-box">
      <div style="color:#3c8dbc" class="login-logo">
        <img style="margin-top:-12px" src="assets/img/logo_pro_normal.png" alt="Logo" height="130"> 
		
      </div><!-- /.login-logo -->

	  <h3 align="center"> <span class="label label-primary"> SISTEMA DE GESTIÓN INTEGRAL  - SGI </span> </h3>
	  <h3></h3>
